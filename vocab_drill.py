...
phrases = [
          ...
          ["a significant/impressive book", "un grand livre"],
          ["a thick/heavy book", "un gros livre"],
          ["a serious/universal problem", "un grand probl\u00e8me"],
          ["a serious, personal problem", "un gros probl\u00e8me"],
          ["important ideas/concepts", "les grands mots"],
          ["swearwords/bad language", "les gros mots"],
          ["to be big-hearted/generous", "avoir le coeur grand"],
          ["to be heavy-hearted/upset", "avoir le coeur gros"],
          ["companies must address customers in an inspiring manner",
           "les enterprises doivent s'adresser aux clients de mani\u00e8re unique."],
          ["it is often easy to see when baby is teething",
           "il est souvent facile de s'apercevoir que b\u00e9b\u00e9 fait ses dents"],
          ["the real problem should not be called overpopulation but overconsumption",
           "le v\u00e9ritable probl\u00e8me ne devrait pas s'appeler surpopulation mais surconsommation"],
          ["the lights begin to flicker as they hear the wraith approaching",
           "les lumi\u00e8res commencent \u00e0 vaciller quand ils entendent l'apparition s'approcher"],
          ["they have to stop frequently",
           "ils doivent s'arr\u00eater fr\u00e9quemment"],
          ["the chair is extremely comfortable to sit on",
           "la si\u00e8ge est extr\u00eamement confortable pour s'asseoir dessus"],
          ["operatives are given discreet tasks to ensure secrecy",
           "les agents ont des t\u00e2ches discr\u00e8tes pour s'assurer du secret"],
          ["the changing rooms are this way",
           "la pi\u00e8ce pour se changer est ici"],
          ["we are supposed to behave like adults",
           "on est cens\u00e9 se conduire en adulte"],
          ["he never wants to go to bed",
           "il vet jamais aller se coucher"],
          ["it is necessary to get rid of the decorative elements",
           "il est d\u00e9cessaire de se d\u00e9barrasser des \u00e9l\u00e9ments d\u00e9coratifs"],
          ["your wife is probably wondering where you are",
           "votre femme doit se demander o\u00fb vous \u00eates"],
          ["just tell him to hurry up",
           "mais dis lui de se d\u00e9p\u00eacher"],
          ["researchers can therefore conduct their research without having to move about",
           "les chercheurs peuvent donce mener leurs recheres sans avoir \u00e0 se d\u00e9placer"],
          ["the insults bother me very little",
          ...
          ["I don't blame you for being suspicious",
           "Je ne t'en veux pas d'\u00eatre suspicieux"],
          ["excuse me, where are the toilets?",
           "je m'excuse, ou est les toilettes?"],
          ...
          ["I have many routes of different lengths",
           "j'ai beaucoup d'itin\u00e9raires de diff\u00e9rentes longueurs"],
          ["the elevation profile", "le profil d'\u00e9l\u00e9vation"],
          ["the big shoulder of the road", "le grand accotement de la route"],
          ["starting off I felt ok (imparfait)", "au d\u00e9part je me sentais bien"],
          ...
          ["we hired an instructor (passe compose)", "nous avons embauch\u00e9 un instructeur"],
          ["the first thing he showed us", "la premiere chose qu'il nous a montr\u00e9"],
          ["it helped me (passe compose)", "\u00e7a m'a aid\u00e9"],
          ["for an actual game", "pour un vrai jeu"],
          ...
          ["we returned from golf (passe compose)",
           "nous sommes revenus du golf"],
          ...
          ["for what y'all get", "pour ce que vous obtenez"],
          ["give me back my toy", "rends-moi mon jouet"],
          ["last Saturday", "samedi dernier"],
          ["ready for them", "pr\u00eat pour eux"],
          ["fresh for them", "fraiment pour eux"],
          ...
          ["I did not feel well (imparfait)", "je ne me sentais pas bien"],
          ...
          ["he retired (passe compose)", "il a pris sa retraite"],
...
nouns = [ ["the coal", "le charbon"],
          ...
          ["the bridal shower", "la douche nuptiale"],
          ["the high tea", "le go\u00fbter d\u00eenatoire"],
          ["allergy", "allergie"],
          ["the vineyard", "le vignoble"],
          ["the winery", "la cave"],
          ["the bride groom", "le jeune mari\u00e9"],
          ...
          ["the jeans", "le jean"],
          ["the tights", "le collants"],
          ["the winter coat", "le manteau d'hiver"],
          ["the rain jacke3t", "la veste de pluie"],
          ["the socks", "le chaussette"],
          ["the shoe", "le soulier"],
          ["the underwear", "le sous-v\u00e7tement"],
          ["the undershirt", "le maillot de corps"],
          ["the bathing suit", "le maillot de bain"],
          ["the dress", "la robe"],
          ["the skirt", "la jupe"],
          ["the blouse", "la chemisier"],
          ["the sunglasses", "le lunettes de soleil"],
          ["the mitten", "la mitaine"],
          ["the glove", "le gant"],
          ["the scarf", "la foulard"],
          ["the trade show", "le foire-exposition"],
          ["the glasses", "les lunettes"],
          ["the habit", "l'habitude"],
          ["the driver(m)", "le conducteur"],
          ["the driver(f)", "la conductrice"],
          ["the gas(oline)", "l'essence"],
          ["artificial fabric", "tissu artificiel"],
          ["the hail", "la gr\u00eale"],
          ["the steps", "les etapes"],
          ["the speaker (stereo)", "le haut-parleur"],
          ["the path", "le chemin"],
          ...
          ["the small operation", "la petite op\u00e9ration"],
          ...
          ["the big helicopter", "le grand h\u00e9licopt\u00e8re"],
          ["a plant", "une plante"],
          ["the bottom", "le fond"],
          ["the apple", "la pomme"],
          ["the almond", "l'amande"],
          ...
          ["an eggshell", "une coquille d'ouef"],
          ["an award", "un prix"],
          ["procedure", "proc\u00e9dure"],
          ...
          ["the goat", "la ch\u00e8vre"],
          ["the cow", "la vache"],
          ["the sheep(f)", "la brebis"],
          ["the sheep(m)", "le mouton"],
...
present_verbs = [ ["I run", "je cours"],
                  ...
                  ["I enlarge", "j'agrandis"],
                  ["you enlarge", "tu agrandis"],
                  ["he enlarges", "il agrandit"],
                  ["she enlarges", "elle agrandit"],
                  ["we enlarge", "nous agrandissons"],
                  ["y'all enlarge", "vous agrandissez"],
                  ["they(m) enlarge", "ils agrandissent"],
                  ["they(f) enlarge", "elles agrandissent"],
...
imparfait_verbs = [ ["I ran", "je courais"],
                    ...
                    ["I enlarged", "j'agrandissais"],
                    ["you enlarged", "tu agrandissais"],
                    ["he enlarged", "il agrandissait"],
                    ["she enlarged", "elle agrandissait"],
                    ["we enlarged", "nous agrandissions"],
                    ["y'all enlarged", "vous agrandissiez"],
                    ["they(m) enlarged", "ils agrandissaient"],
                    ["they(f) enlarged", "elles agrandissaient"],
...
futur_simple_verbs = [
                    ...
                    ["I will enlarge", "j'agrandirai"],
                    ["you will enlarge", "tu agrandiras"],
                    ["he will enlarge", "il agrandira"],
                    ["she will enlarge", "elle agrandira"],
                    ["we will enlarge", "nous agrandirons"],
                    ["y'all will enlarge", "vous agrandirez"],
                    ["they(m) will enlarge", "ils agrandiront"],
                    ["they(f) will enlarge", "elles agrandiront"],
...
passe_compose_verbs = [
                    ...
                    ["I enlarged", "j'ai agrandi"],
                    ["you enlarged", "tu as agrandi"],
                    ["he enlarged", "il a agrandi"],
                    ["she enlarged", "elle a agrandi"],
                    ["we enlarged", "nous avons agrandi"],
                    ["y'all enlarged", "vous avez agrandi"],
                    ["they(m) enlarged", "ils ont agrandi"],
                    ["they(f) enlarged", "elles ont agrandi"],
